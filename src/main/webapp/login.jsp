...
<body
	style="background-image: url('${pageContext.servletContext.contextPath }/admin_files/logo1.jpg');margin-top:0px;">
				...
				<table style="width: 100%">
					<tr>
						<td align="left"><img
							...
							alt="Logo"></td>
							<td align="center" style="font-weight: bold;color: gray;">飓风管理系统</td>
						<td align="right"><img
							src="${pageContext.servletContext.contextPath }/admin_files/logo_left.png"
							alt="Logo"></td>
					</tr>
