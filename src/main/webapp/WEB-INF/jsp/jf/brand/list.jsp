...
<!-- 公共 -->
<script type="text/javascript" src="${ctx}/js/jf/brand/list.js"></script>
</head>
<body>
	...
	<div class="doc-buttons">
		<a href="javascript:void(0);" class="btn btn-s-md btn-primary btn-rounded" id ="addBrand">新增</a>
		<a href="javascript:void(0);" class="btn btn-s-md btn-info btn-rounded" id ="editBrand">编辑</a>
		<a href="javascript:void(0);" class="btn btn-s-md btn-danger btn-rounded" id ="delBrand">删除</a>
	</div>
	</header>
