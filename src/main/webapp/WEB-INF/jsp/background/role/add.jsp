...
<script type="text/javascript" src="${ctx}/js/role/add.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/background/role/add.shtml">
					...
					<div class="btn-group m-r">
						...
						<ul class="dropdown-menu dropdown-select">
							<li class=""><a href="#"><input type="radio"
									name="enable" value="0" checked="checked">是</a></li>
							<li class="active"><a href="#"><input type="radio"
									name="enable" value="1">否</a></li>
						</ul>
					</div>
				</div>
			</div>
