...
<body>
	<div class="col-md-12"><button onclick="tips_pop()">3秒后会在右下角自动弹出窗口，如果没有弹出请点击这个按钮</button>
		...
		<div class="alert alert-danger">
			<button type="button" class="close" data-dismiss="alert">×</button>
								<div style="font-size: 17px;">
							     ...
							     </div><img alt="蓝缘系统的支付连接" src="${ctx}/images/zhifubao.png" title="蓝缘系统的支付连接"> <span title="蓝缘系统的支付连接" style="font-size: 20px;color: blue;" >支付宝账号是:mmm333zzz520@163.com</span><br> <span title="蓝缘系统的支付连接" style="font-size: 20px;color: blue;" >支付地址: 支付地址已经关闭,亲可以直接转到支付宝账号上，记得备注哦！</span>
								</div>
	</div>
	<div class="col-md-6">
			...
			<table style="width: 100%; height: 100%;">
				...
				<tr>
					<td width="116"><img alt="蓝缘系统的支付连接"
						src="${ctx}/images/zhifubao.png"></td>
